...
print("\nIndex Sizes:")
# print(f"SPbGU - Classical: {spbgu_classical_size[0]} bytes")
# print(f"SPbGU - Compressed: {spbgu_compressed_size[1]} bytes")
print(f"MSU - Compressed: {msu_classical_size[0]} bytes")
print(f"MSU - Classical: {msu_compressed_size[1]} bytes")
...
# Gather search tasks
search_tasks = asyncio.gather(msu_classical_task)
